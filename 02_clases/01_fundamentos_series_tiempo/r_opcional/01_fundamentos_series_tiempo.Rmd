...
library(highcharter)
library(rio)
df=rio::import("https://github.com/Wilsonsr/Series-de-Tiempo/raw/main/03_datos/compartidos/ipc_colombia_mensual.xlsx")
...
```{r, message=FALSE, warning=FALSE}
library(readr)
amazon=rio::import("https://github.com/Wilsonsr/Series-de-Tiempo/raw/main/03_datos/01_fundamentos/amazon.csv")
...
```{r,message=FALSE}
library(readr)
oilfilters=rio::import("https://github.com/Wilsonsr/Series-de-Tiempo/raw/main/03_datos/01_fundamentos/filtros_aceite.dat", format=",")
...
```{r}
df=rio::import("https://github.com/Wilsonsr/Series-de-Tiempo/raw/main/03_datos/15_avanzados/respiratorios.xlsx")
```
