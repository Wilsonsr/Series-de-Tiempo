...
```{r}
rec = scan("https://raw.githubusercontent.com/Wilsonsr/Series-de-Tiempo/main/03_datos/09_sarimax/recruitment.dat")
soi=scan("https://raw.githubusercontent.com/Wilsonsr/Series-de-Tiempo/main/03_datos/09_sarimax/soi.dat")
```
